 ...
 * @license   GNU
 */
class ModuleProductsCompare extends ModuleProducts {

    /**
     * Template
     * @var string
     */
    protected $strTemplate = 'mod_dse_products_compare';
    ...
    public function generate() {
        if (TL_MODE == 'BE') {
            ...
            $objTemplate->wildcard = '### ' . $GLOBALS['TL_LANG']['MOD']['dse_products_compare'][0] . ' ###';
